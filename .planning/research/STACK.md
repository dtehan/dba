...
**Domain:** Local desktop AI chat application — Teradata DBA tooling
**Researched:** 2026-03-24
**Confidence:** HIGH (core framework, verified via official sources); MEDIUM (supporting libraries)
...
npm create @quick-start/electron@latest dba-agent -- --template react-ts
...
npm install lucide-react date-fns streamdown react-syntax-highlighter
...
# Dev dependencies
npm install -D @types/node vitest @electron/rebuild prettier prettier-plugin-tailwindcss eslint @typescript-eslint/eslint-plugin eslint-plugin-react-hooks
```
...
**If the user wants to package for Windows only (no macOS/Linux):**
...
**If Teradata connection fails (firewall, version < 16.20, ODBC required):**
...
**If subagent tasks exceed Claude Agent SDK's single-hop design:**
...
**If chat history grows beyond ~1MB:**
...
*Stack research for: Teradata DBA Agent — local desktop AI chat application*
*Researched: 2026-03-24*

...
**Plans:** 3 plans
Plans:
- [ ] 05-01-PLAN.md — Backend pipeline: extend types, parameterize SQL with sort/time range, add EXPLAIN IPC, update store
...
| 5. Query Activity Redesign | v1.1 | 0/3 | Planned | — |
